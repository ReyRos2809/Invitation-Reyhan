...
<html lang="en">
  <head>
    ...
    <title>Reyhan Proposed Dite</title>
    <style>
      body {
        /* ganti background website */
        background-image: URL(https://www.freepik.com/free-photo/couple-love-holding-cups-tea-coffee-holding-hands_18016858.htm#fromView=search&page=1&position=1&uuid=49950ce8-e3e1-4ee8-b8e3-28a8019b0bd5&new_detail=true);
      }
    </style>
    <link
      rel="stylesheet"
  ...
  <body class="justify-center flex">
    ...
    >
      ...
      <div class="lh-1 text-center mt-4">
        ...
        <!-- ganti pertanyaan -->
        <p class="title question fs-1 text-2xl font-bold text-gray-700">Mau Jalan Jalan Besok Pagi?</p>
      </div>
      ...
      <div class="numbers hidden mt-5 flex justify-center">
        <!-- ganti link -->
        <a
          href="https://maps.app.goo.gl/uTG43hRZurrHAFb29"
          type="button"
    ...
    <script>
      ...
      function generateMessage(count) {
        const messages = ["GAMAU", "hmm?", "yakin?", "GATAULAH", "huftt..", "HARUS PENCET"];
